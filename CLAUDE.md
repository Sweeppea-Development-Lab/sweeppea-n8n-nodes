...
- Exceptions: Reserved words or conventional names:
  - Express/Node.js: `req`, `res`, `next`, `error`, `err`
  - Promises/Callbacks: `resolve`, `reject`, `callback`
  - Events: `event`, `e`
  - Common patterns: `response`, `request`, `result`, `data`
